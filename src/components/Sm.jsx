...
import sm10 from "../assets/husa.jpg";
import sm11 from "../assets/husa1.jpg";
const Sm = () => {
  const divStyle =
    "overflow-hidden flex items-center justify-center border-[6px] border-[#4c4c4c] rounded-xl ";
  const imgStyle =
    "w-full h-full object-contain shadow-lg cursor-pointer rounded-xl";
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 ">
      ...
      <div className={`${divStyle}`}>
        <img src={sm11} width={300} alt="" className={imgStyle} />
      </div>
      <div className={`${divStyle}`}>
      ...
      <div className={`${divStyle}`}>
        <img src={sm10} width={300} alt="" className={imgStyle} />
      </div>
    </div>
  );
};
